...
> [!NOTE]
> Since this is a fork of [Typo](https://github.com/tomfran/typo), consider contributing to the original project if your change is not specific to this fork.
...
- format the code with `npm run format` before submitting a PR.
